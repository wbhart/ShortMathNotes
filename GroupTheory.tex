...
\subsubsection{Subgroups, Quotients and Direct Products of Nilpotent Groups are Nilpotent}
...
\begin{definition}
An abelian group $G$ is finitely generated if there exist $g_1, g_2, \ldots, g_n \in G$ such that every element of $G$ is a product of powers of the $g_i$ and their inverses.
\end{definition}
